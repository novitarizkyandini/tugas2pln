...
<head>
	...
	<title>Tugas 2 | PBWL Project10</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/logo-pln.ico" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/logo-pln.png" class="brand">
	...
	<main>
		...
		<footer>
			Copyright &copy; 2022 - <?php echo date('Y'); ?>. Designed by NOVITA RIZKY ANDINI
		</footer>
	</main>
